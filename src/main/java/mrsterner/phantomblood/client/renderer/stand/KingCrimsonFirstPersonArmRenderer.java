...
public class KingCrimsonFirstPersonArmRenderer implements WorldRenderEvents.Last {
    ...
    public KingCrimsonFirstPersonArmRenderer(EntityModelLoader loader) {
        model = new KingCrimsonModel(loader.getModelPart(PhantomBloodClient.KING_CRIMSON_MODEL_LAYER));
    }
