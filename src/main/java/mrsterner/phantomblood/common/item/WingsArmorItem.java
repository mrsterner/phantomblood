...
import dev.emi.trinkets.mixin.ElytraFeatureRendererMixin;
...
public class WingsArmorItem extends GeoArmorItem implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public WingsArmorItem(ArmorMaterial materialIn, EquipmentSlot slot) {
