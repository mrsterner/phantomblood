...
public class TheWorldModel extends EntityModel<Entity> {
    ...
    public TheWorldModel() {
        ...
        head.setTextureOffset(0, 0).addCuboid(-4.5F, -9.1F, -2.0F, 9.0F, 2.0F, 7.0F, 0.0F, false);
        ...
        faceplate_r1.setTextureOffset(45, 61).addCuboid(-5.0F, -0.5F, 0.0F, 5.0F, 4.0F, 2.0F, 0.0F, false);
        ...
        faceplate_r2.setTextureOffset(16, 60).addCuboid(0.0F, -0.5F, 0.0F, 5.0F, 4.0F, 2.0F, 0.001F, false);
        ...
        body.setTextureOffset(46, 9).addCuboid(1.0F, -1.0F, -3.0F, 2.0F, 11.0F, 6.0F, 0.0F, false);
        body.setTextureOffset(28, 65).addCuboid(-2.5F, 0.0F, 3.0F, 2.0F, 8.0F, 2.0F, 0.0F, false);
        body.setTextureOffset(59, 61).addCuboid(0.5F, 0.0F, 3.0F, 2.0F, 8.0F, 2.0F, 0.0F, false);
        body.setTextureOffset(38, 40).addCuboid(-3.0F, -1.0F, -3.0F, 2.0F, 11.0F, 6.0F, 0.0F, false);

        lower = new ModelPart(this);
        lower.setPivot(0.0F, 23.0F, -2.0F);
        body.addChild(lower);
        lower.setTextureOffset(50, 53).addCuboid(-3.5F, -16.0F, 0.0F, 7.0F, 4.0F, 4.0F, 0.0F, false);
        lower.setTextureOffset(25, 0).addCuboid(-4.0F, -13.0F, -1.5F, 8.0F, 2.0F, 7.0F, 0.0F, false);
        lower.setTextureOffset(62, 12).addCuboid(3.0F, -14.0F, 0.5F, 2.0F, 3.0F, 3.0F, 0.0F, false);
        lower.setTextureOffset(22, 14).addCuboid(-5.0F, -14.0F, 0.5F, 2.0F, 3.0F, 3.0F, 0.0F, false);

        right = new ModelPart(this);
        right.setPivot(-2.25F, -11.0F, 2.0F);
        lower.addChild(right);
        setRotationAngle(right, -0.7854F, 0.1745F, 0.1745F);
        right.setTextureOffset(15, 48).addCuboid(-2.75F, -0.5F, -2.5F, 5.0F, 7.0F, 5.0F, 0.0F, false);
        ...
        left.setPivot(2.0F, -11.0F, 2.0F);
        lower.addChild(left);
        setRotationAngle(left, 0.0873F, -0.4363F, -0.3927F);
        left.setTextureOffset(48, 32).addCuboid(-2.0F, -0.5F, -2.5F, 5.0F, 7.0F, 5.0F, 0.0F, false);
        ...
        leftArm.setTextureOffset(57, 21).addCuboid(0.0F, -3.0F, -2.5F, 4.0F, 4.0F, 5.0F, 0.0F, false);

        arm = new ModelPart(this);
        arm.setPivot(-4.0F, 2.0F, 0.0F);
        leftArm.addChild(arm);
        arm.setTextureOffset(31, 57).addCuboid(4.5F, -1.0F, -2.0F, 3.0F, 4.0F, 4.0F, 0.0F, false);
        ...
        hand_r1.setTextureOffset(56, 0).addCuboid(-2.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, 0.0F, false);
        ...
        arm_r1.setTextureOffset(30, 9).addCuboid(-1.5F, 0.0F, -2.0F, 3.0F, 4.0F, 4.0F, 0.0F, false);
        ...
        hand_r2.setTextureOffset(0, 56).addCuboid(-2.0F, -1.0F, -2.0F, 4.0F, 8.0F, 4.0F, 0.0F, false);
    }
    @Override
