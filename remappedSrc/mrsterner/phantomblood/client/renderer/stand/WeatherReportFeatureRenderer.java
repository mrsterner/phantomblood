...
public class WeatherReportFeatureRenderer<T extends LivingEntity> extends FeatureRenderer<T, EntityModel<T>> {
    private final WeatherReportModel idleModel;
    private static final Identifier texture = new Identifier("phantomblood:textures/entity/stand/weather_report.png");

    public WeatherReportFeatureRenderer(FeatureRendererContext<T, EntityModel<T>> context, WeatherReportModel idleModel) {
        super(context);
