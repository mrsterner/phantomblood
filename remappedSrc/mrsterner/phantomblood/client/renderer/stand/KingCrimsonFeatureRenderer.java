...
public class KingCrimsonFeatureRenderer<T extends LivingEntity> extends FeatureRenderer<T, EntityModel<T>> {
    private final KingCrimsonModel model;
    private static final Identifier texture = new Identifier("phantomblood:textures/entity/stand/king_crimson.png");

    public KingCrimsonFeatureRenderer(FeatureRendererContext<T, EntityModel<T>> context, KingCrimsonModel model) {
        super(context);
        this.model = model;
    }
